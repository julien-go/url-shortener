export function HomeLanding() {
  return (
    <section
      className={`space-y-6 md:space-y-9 flex min-h-[60vh] flex-col justify-center`}
    >
      <div
      ...
      >
        <div className="relative space-y-4.5">
          ...
          <div
            className={`mx-auto max-w-2xl mt-7 rounded-xl border border-border bg-card/96 p-5 text-left shadow-[var(--shadow-surface)]`}
          >
            ...
            <p className="mt-1 font-mono text-[1.55rem] font-extrabold text-foreground sm:text-[1.7rem]">
              https://sho.rt/q4-launch
            </p>
            <p className="mt-1 text-xs text-muted-foreground">
              128 clicks · 24h · Last click 3m ago
            </p>
          </div>
        </div>
      </div>
